...
namespace OneWayLabyrinth
{
    public partial class Path
    {
        ...
        void ApplyRules()
        {
            ...
            // 2024_0611_4, 2024_0611_5, 2024_0611_6, 9_234212, 9_522267
        ...
        void CheckCShapeNext() // 2024_0611_5, 2024_0611_6
        {
            for (int i = 0; i < 2; i++)
            {
                for (int j = 0; j < 4; j++)
                                ...
                                else
                                {
                                    ...
                                    if (!takenFound)
                                    {
                                        ...
                                        if (CountAreaRel(left1, straight1, left2, straight2, newBorderFields, circleDirectionLeft, 2, true))
                                        {
                                            ...
                                            if (hori == 2)
                                            {
                                                if (vert % 4 == 3 && j < 2) // 2024_0610, 2024_0610_1, 2024_0625_1, 2024_0611_3 (21 cutout)
                                                {
                                            ...
                                            if (hori == vert + 3 && -whiteDiff == 1) // 2024_0725_6, corner 2 5 stair (shows large area)
                                            {
                                                int m;
                                                for (m = 1; m <= vert; m++)
                                                {
...

        {
            for (int i = 0; i < 2; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    ...
                    // stair start, 2024_0630, 2024_0720, 2024_0723
                    ...
                    if (startObstacleValid)
                    {
                        ...
                        {
                            if (hori == 4 && (vert == -1 || vert == 0)) // 2024_0727_5. We need to think about a general UpExtended start area where distance to the obstacle % 4 = 3.
                            {
                                List<int[]> borderFields = new();
                        ...
                        if (sequenceValid)
                        {
                            ...
                            if (!stairStart && !stairStart2)
                            {
                                if (hori == 4 && (vert == -1 || vert == 0)) // 2024_0727_5
                                {
                                    path.Add(new int[] { x + lx, y + ly });
                            ...
                            {
                                // Add straight field and left up (the second field needs to be added to establish found corner direction later in the sequence: 2024_0723
                                path.Add(new int[] { x + sx, y + sy });
        ...
        public bool InTaken(int x, int y) //more recent fields are more probable to encounter, so this way processing time is optimized
        {
            if (!isMain)
            {
                ...
                {
                    int[] field = path[i];
                    if (x == field[0] && y == field[1]) // In 2023_0919_1 (step right, the near end of the bottom line extends), even if the near end being stepped on is now inactive, it is not an option (Near end cannot connect to near end.) Active checking is unnecessary.
                    {
                        return true;
                    }
                }
