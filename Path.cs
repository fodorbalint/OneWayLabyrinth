...
namespace OneWayLabyrinth
{
    public partial class Path
    {
        ...
        // 0706, 2024_1001: corner -> StairAtEndConvexStraight3
...

        {
            for (int i = 0; i < 2; i++)
            {
                ...
                for (int j = 0; j < 4; j++)
                {
                    ...
                    // stair start, 2024_0630, 0720, 0723
                        ...
                        if (sequenceValid)
                        {
                            ...
                            while (stepFound || farStraightFound)
                            {
                                ...
                                if (CheckCorner(hori - 2 * hx, vert - 2 * hy, 0, rotationIndex2, circleDirectionLeft, true) && CheckNearFieldSmallRel0(hori - 2 * hx, vert - 2 * hy, 1, rotationIndex3, true))
                                {
                                    ...
                                    if (!stairStart) // 0704, 1014, 0724, 0725_2, 2024_1006, 2026_0404, 2026_0405
                                    {
        ...
        void CheckFutureCShape() // Even future line can make a straight C-shape, see 2023_0727_1
        {
